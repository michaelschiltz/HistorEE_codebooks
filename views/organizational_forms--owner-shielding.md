# Scoped view — component `owner-shielding`
...
| `casa_san_giorgio`           | .NR   | .NR   |
| `commenda`                   | 0     | 1     |
| `compagnia`                  | 0     | 0     |
| `compagnie_antwerpen_1582`   | 0     | 0     |
| `compagnie_antwerpen_1608`   | 0     | 0     |
| `deed_of_settlement_company` | 0     | 0     |
| `fraterna`                   | .NR   | .NR   |
| `hegu_shengu`                | --    | --    |
| `hegu_yingu`                 | .NR   | .NR   |
| `isqa`                       | 0     | 1     |
...
- **`AP3` owner shielding limited liability** (ternary) — ternary: `1` present, `P` partial, `0` absent
- **`LR1` liability extent** (nominal) — `0` = unlimited-joint; `1` = unlimited-several; `2` = limited; `3` = none
