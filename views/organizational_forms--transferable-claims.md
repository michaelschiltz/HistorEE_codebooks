# Scoped view — component `transferable-claims`
...
| `deed_of_settlement_company` | 1     | P     |
| `fraterna`                   | .NR   | .NR   |
| `hegu_shengu`                | 0     | 0     |
| `hegu_yingu`                 | 1     | 1     |
| `isqa`                       | 0     | 0     |
...
- **`CI3` transferable interest** (ternary) — ternary: `1` present, `P` partial, `0` absent
- **`CI4` depersonalised interest** (ternary) — ternary: `1` present, `P` partial, `0` absent
