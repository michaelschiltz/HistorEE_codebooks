# Scoped view — component `outcome-coupling`
...
- **`LR2` outcome coupling** (ordinal) — `0` = coupled; `1` = attenuated; `2` = veiled
- **`LR6` coupling symmetry** (nominal) — `0` = symmetric; `1` = upside-only; `2` = downside-only
